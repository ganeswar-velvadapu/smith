  ...
  return (
    <div className=''>
      ...
      <div className="welcomeMessage flex flex-col items-center p-4">
        <h1 className="text-5xl lg:text-7xl font-bold mb-8">Welcome</h1>
        <p className="max-w-4xl leading-relaxed text-2xl">
        ...
        <br />
        <div className='flex flex-col items-start md:w-[47%]'>
        <p className="max-w-4xl leading-relaxed text-4xl md:text-5xl font-semibold">
          Some key research areas include:
        </p>
        <ul className="list-disc list-inside mt-2 text-xl md:text-2xl">
